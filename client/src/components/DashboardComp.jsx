      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <div className="flex flex-col p-3 dark:bg-sky-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            ...
            <HiOutlineUserGroup className="text-5xl bg-teal-600 text-white rounded-full p-3 shadow-lg" />
          </div>
        ...
        <div className="flex flex-col p-3 dark:bg-sky-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            ...
            <HiAnnotation className="text-5xl bg-indigo-600 text-white rounded-full p-3 shadow-lg" />
          </div>
          <div className=" flex gap-2 text-sm">
            <span className=" text-gray-500 flex items-center ">
              <HiArrowNarrowUp />
        ...
        <div className="flex flex-col p-3 dark:bg-sky-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            ...
            <HiDocumentText className="text-5xl bg-lime-600 text-white rounded-full p-3 shadow-lg" />
          </div>
          <div className=" flex gap-2 text-sm">
            <span className=" text-gray-500 flex items-center ">
              <HiArrowNarrowUp />
